...
//	RCC_APB2PeriphClockCmd( RCC_APB2Periph_GPIOA | RCC_APB2Periph_GPIOC, ENABLE);   
	...
	GPIO_InitStructure.Pin = 	AD9854_A0_PIN  | AD9854_A1_PIN 		|	AD9854_A2_PIN 	| AD9854_RD_PIN  
													| AD9854_WR_PIN  | AD9854_UDCLK_PIN | AD9854_RST_PIN 	| AD9854_SP_PIN; ; 
...
void AD9854_Init(void)
{
	...
	delay_us (100);                // 对应例程的Delay_10us(10)
	AD9854_RST_Clr;
	SPI_IO_RST_Clr;
	AD9854_RD_Clr;
