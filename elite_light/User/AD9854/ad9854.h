...
#define AD9854_UDCLK_Set    HAL_GPIO_WritePin(GPIOC,GPIO_PIN_10,GPIO_PIN_SET)           // 时钟信号
...
#define AD9854_SP_Set    HAL_GPIO_WritePin(GPIOC,GPIO_PIN_12,GPIO_PIN_SET)         // 串行低电平，并行高电平
...
// I/O驱动  使用别名
#define SPI_IO_RST_Set    HAL_GPIO_WritePin(GPIOA,GPIO_PIN_7,GPIO_PIN_SET)            // DDS的A2口与STM32的PA7连接
#define SPI_IO_RST_Clr    HAL_GPIO_WritePin(GPIOA,GPIO_PIN_7,GPIO_PIN_RESET)          // 串行IO允许复位

#define SPI_SDO_Set    HAL_GPIO_WritePin(GPIOA,GPIO_PIN_6,GPIO_PIN_SET)               // DDS的A1口与STM32的PA6连接
#define SPI_SDO_Clr    HAL_GPIO_WritePin(GPIOA,GPIO_PIN_6,GPIO_PIN_RESET)             // 单向串行传输端口,3线串行通信

#define SPI_SDI_Set 	 HAL_GPIO_WritePin(GPIOA,GPIO_PIN_5,GPIO_PIN_SET)             // DDS的A0口与STM32的PA5连接
#define SPI_SDI_Clr 	 HAL_GPIO_WritePin(GPIOA,GPIO_PIN_5,GPIO_PIN_RESET)           // 双向串行数据输入输出，2线串行
